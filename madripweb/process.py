...
class Generate_Report:
    ...
    def writeResult(self):
        ...
        file.drawString(200,775,self.ExudateImageName)
...
class Feature_Extraction:
    ...
    def Extract(self):
        ...
        report.setExudateImage(self.resultantImage)
...
class DME_Identification:
    ...
    def identifyDME(self,name,gpu=None):
        ...
        with torch.no_grad():
            ...
            report.setDR_stage(str(self.DRstage))
            report.setDME_stage(str(self.Stage))
